...
GO
/*
Para terceros proveedores y proveedores se debe ejecutar de la siguiente forma  la query  para que nos traiga los 
proveedores asignados por sucursal PSUC debido a que estos proveedores se asignaron por sucursal en la query  pero el filtro no nos  devuelve nada debido 
a la complejidad de la misma función.
Se tiene que descomentar el cursor  y el filtro en la busqueda de datos principales  que sería el filtro de la tabla temporal unida.
Los datos resultante se pasan al Excel correspondiente  y se ordenan mediante una función de datos intercalados acomodando los indicadores e importandolos al Sage
...
CREATE TABLE #tmpSucursal (
	...
	descripcion VARCHAR(25) NOT NULL
        ...
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0349',	'0F019',	'FASANO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0350',	'0F052',	'FELISSIA',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0351',	'0H024',	'HID SANFCO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0352',	'0O041',	'HP HIDRAU',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0353',	'0H045',	'PIRLES',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0354',	'0I070',	'I-RON',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0355',	'0I071',	'OLEO SAN J',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0356',	'0K001',	'KADIMA',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0357',	'0L020',	'LASERPLAST',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0358',	'0L067',	'GL OLEO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0359',	'0L075',	'ALU-MAQ',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0360',	'0L092',	'LHPLAST',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0361',	'0L110',	'MJ RADIAD',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0362',	'0M064',	'BOTTA',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0363',	'0M065',	'MET NB',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0364',	'0M073',	'MORO HID',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0365',	'0M152',	'MACIEL',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0366',	'0M211',	'A MORO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0367',	'0M243',	'MASTER G',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0368',	'0N058',	'NGB',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0369',	'0O016',	'EL TORITO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0370',	'0P028',	'J BAZAN',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0371',	'0P078',	'PIETRANTUO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0372',	'0P093',	'PILMHOR',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0373',	'0P137',	'VALSUSO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0374',	'0P146',	'RJP',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0375',	'0S132',	'SENSOR',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0376',	'0S135',	'SABBATINI',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0377',	'0S195',	'SCHNEIDER',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0378',	'0S197',	'SALVAGNO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0379',	'0T036',	'TECNIDRA',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0380',	'0T062',	'CARCANO',	1	)
        INSERT INTO #DatosProveedores VALUES	(	'PVA-0381',	'0V008',	'VERION',	1	)
...
INSERT INTO #ProveedoresData
	...
	,  proveed.[PR_FECHASIBR], proveed.[MO_CODIGO], proveed.[PR_FECHA_CAI], proveed.[PR_NUMERO_CAI], proveed.[PR_CALRETLIMP], proveed.[PR_CALRETSEG]
	,  prov.[proveedor], prov.[sigla], prov.[descripcionCorta]
	FROM [172.17.2.100].[MendozaZeus].[dbo].[PROVEEDORES] proveed INNER JOIN #DatosProveedores prov 
	ON proveed.PR_CODIGO = prov.sigla 
...
INSERT INTO #ProveedoresData
	...
	, proveed.[PR_FECHASIBR], proveed.[MO_CODIGO], proveed.[PR_FECHA_CAI], proveed.[PR_NUMERO_CAI], proveed.[PR_CALRETLIMP], proveed.[PR_CALRETSEG]
	, prov.[proveedor], prov.[sigla], prov.[descripcionCorta]
	FROM [172.17.3.100].[BahiaZeus].[dbo].[PROVEEDORES] proveed INNER JOIN #DatosProveedores prov 
	ON proveed.PR_CODIGO = prov.sigla 
...
INSERT INTO #ProveedoresData
	...
	, proveed.[PR_FECHASIBR], proveed.[MO_CODIGO], proveed.[PR_FECHA_CAI], proveed.[PR_NUMERO_CAI], proveed.[PR_CALRETLIMP], proveed.[PR_CALRETSEG]
	, prov.[proveedor], prov.[sigla], prov.[descripcionCorta]
	    FROM [172.17.6.100].[TucumanZeus].[dbo].[PROVEEDORES] proveed inner join #DatosProveedores prov 
		ON proveed.PR_CODIGO = prov.sigla 
		WHERE  prov.idSucurs = 10*/
...
INSERT INTO ##TMPTABLE_PROVEEDOR
	  ...
	  SELECT  
		...
		--pro.column2 AS [BPSNUM]	,								       --Proveedor
		...
		--UPPER(LEFT(pro.column3, 35))  AS [BPRNAM],				   --Razón Social

		LEFT (p.PR_NOMBRE,10) AS [BPRSHO],							   --Descrip. corta, abreviación de la razón social, se puede dejar en blanco
		...
		p.PR_CODPOS    as [POSCOD],
		--pro.column5 as [CRY2],
		--pro.column6 AS [POSCOD],   --Código Postal                              
		...
		'SEÑOR' AS [CNTTTL],												--Trato   1-Señor, 2-Señora, 3-Señorita
		 LEFT(P.PR_NOMBRE,20) AS CNTFNA,                                    --Nombre
...
CREATE TABLE ##TMPDATA (	
		...
		DECLARE PROVEEDOR_DATOS CURSOR FAST_FORWARD
			FOR
			SELECT DISTINCT*
			FROM t_prov_Dat td
			--where categoria ='PSUC'
		...
		FETCH NEXT FROM PROVEEDOR_DATOS INTO  @categoria, @codigoProveedor, @sigla,@DescripcionCorta, @familiaEstadistica, @familiaEstadistica1, @familiaEstadistica2, @familiaEstadistica3
