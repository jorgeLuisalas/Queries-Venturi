...
SELECT DISTINCT 
		...
		(SELECT CASE UPPER(prov.PO_DESCRI)
			...
			ELSE ''*/
			END) AS [CRY],                     						  --País (AR-Argentina, BR-Brasil, US-Estados unidos)
	  ...
	  CASE (LEFT(C.CL_IVA,20)) 
		...
		LEFT(C.CL_CUIT,18) AS  [XX12DOCNUM],									        --Número de Documento 
...
/*ISNULL((SELECT STUFF ((SELECT ' (' + */(CASE CC.CLC_TIPO --FunciónA
	...
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0002','020001','00102','OEMNACIONAL')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0002','020002','00104','OEMNACIONAL')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0002','020003','00107','OEMNACIONAL')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0003','030001','07024','OEMEXTERIOR')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0003','030002','07046','OEMEXTERIOR')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0003','030003','07051','OEMEXTERIOR')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0004','040001','07002','OEMDISTEXT')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0004','040002','07010','OEMDISTEXT')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0004','040003','07015','OEMDISTEXT')
	INSERT INTO @TMPTABLE_CLIENTESSIGLA VALUES ('C0004','040004','07032','OEMDISTEXT')
