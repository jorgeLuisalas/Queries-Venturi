...
IF OBJECT_ID('tempdb..##TMPTABLE_CLIENTES') IS NOT NULL
    DROP TABLE ##TMPTABLE_CLIENTES


CREATE TABLE ##TMPTABLE_CLIENTES
(
	Indicador VARCHAR(2) NOT NULL,
	[BCGCOD] NVARCHAR(MAX) NOT NULL,
	[BPCNUM] NVARCHAR(MAX) NOT NULL,
	[BPRNAM] INTEGER NOT NULL,
	[BPRSHO] NVARCHAR(MAX) NOT NULL,
	[BPRLOG] NVARCHAR(MAX) NOT NULL,
	[CRY] NVARCHAR(MAX) NOT NULL,
	[LAN] NVARCHAR(MAX) NOT NULL,
	[CRN] NVARCHAR(MAX) NOT NULL,
	[CUR] NVARCHAR(MAX) NOT NULL,
	[ABCCLS] NVARCHAR(MAX) NOT NULL,
	[DME] NVARCHAR(MAX) NOT NULL,
	[FREINV] NVARCHAR(MAX) NOT NULL,
	[IME] NVARCHAR(MAX) NOT NULL,
	[INVPER] NVARCHAR(MAX) NOT NULL,
	[COMCAT] NVARCHAR(MAX) NOT NULL,
	[REP(0)] NVARCHAR(MAX) NOT NULL,
	[REP(1)] NVARCHAR(MAX) NOT NULL,
	[BPCTYP] NVARCHAR(MAX) NOT NULL,
	[OSTCTL] NVARCHAR(MAX) NOT NULL,
	[OSTAUZ] NVARCHAR(MAX) NOT NULL, 
	[TSCCOD(0)] NVARCHAR(MAX) NOT NULL,
	[TSCCOD(1)] NVARCHAR(MAX) NOT NULL,
	[TSCCOD(2)] NVARCHAR(MAX) NOT NULL,
	[BPCINV] NVARCHAR(MAX) NOT NULL,
	[BPAINV] NVARCHAR(MAX) NOT NULL,
	[BPCPYR] NVARCHAR(MAX) NOT NULL,
	[BPAPYR] NVARCHAR(MAX) NOT NULL,
	[BPCRSK] NVARCHAR(MAX) NOT NULL,
	[BPDADD] NVARCHAR(MAX) NOT NULL,
	[BPAADD] NVARCHAR(MAX) NOT NULL,
	[ACCCOD] NVARCHAR(MAX) NOT NULL,
	[VACBPR] NVARCHAR(MAX) NOT NULL,
	[PTE] NVARCHAR(MAX) NOT NULL,
	[XX12NIF] NVARCHAR(MAX) NOT NULL,
	[XX12DOCTYP] NVARCHAR(MAX) NOT NULL,
	[XXX12DOCTYP] NVARCHAR(MAX) NULL,
	[XX12DOCNUM] NVARCHAR(MAX) NOT NULL,
	[XX12REGIIBB] NVARCHAR(MAX) NOT NULL,
	[XX12IIBB] NVARCHAR(MAX) NOT NULL,
	[XX12SITGAN] NVARCHAR(MAX) NOT NULL,
	[XX12MTBBPR] NVARCHAR(MAX) NOT NULL,
	[XX12PERFLG] NVARCHAR(MAX) NOT NULL,
	[XX12BPRINT] NVARCHAR(MAX) NOT NULL,
	...
	INDICADOR2 NVARCHAR(MAX) NOT NULL,
	[BPAADD2] NVARCHAR(MAX) NOT NULL,
	[BPADES] NVARCHAR(MAX) NOT NULL,
	[BPAADDLIG(0)] NVARCHAR(MAX) NOT NULL,
	[BPAADDLIG(1)] NVARCHAR(MAX) NOT NULL,
	[BPAADDLIG(2)] NVARCHAR(MAX) NOT NULL,
	[POSCOD] NVARCHAR(MAX) NOT NULL,
	[CTY] NVARCHAR(MAX) NOT NULL,
	[CRY2] NVARCHAR(MAX) NOT NULL,
	[BPAADDFLG] NVARCHAR(MAX) NOT NULL,
	[TEL(0)] NVARCHAR(MAX) NOT NULL,
	[TEL(1)] NVARCHAR(MAX) NOT NULL,
	[TEL(2)] NVARCHAR(MAX) NOT NULL,
	[FCYWEB] NVARCHAR(MAX) NOT NULL,
	[WEB(0)] NVARCHAR(MAX) NOT NULL,
	[WEB(1)] NVARCHAR(MAX) NOT NULL,
	[WEB(2)] NVARCHAR(MAX) NOT NULL,	
	[FAX] NVARCHAR(MAX) NOT NULL,


	INDICADOR_D NVARCHAR(MAX) NOT NULL,
	[BPAADD3] NVARCHAR(MAX) NOT NULL,
	[BPDNAM(0)] NVARCHAR(MAX) NOT NULL,
	[VACBPR3] NVARCHAR(MAX) NOT NULL,
	[REP(0)3] NVARCHAR(MAX) NOT NULL,
	[REP(1)3] NVARCHAR(MAX) NOT NULL,
	[STOFCY] NVARCHAR(MAX) NOT NULL,
	[DRN] NVARCHAR(MAX) NOT NULL,
	[DLVPIO] NVARCHAR(MAX) NOT NULL,
	[MDL] NVARCHAR(MAX) NOT NULL,
	[BPTNUM] NVARCHAR(MAX) NOT NULL,
	[DAYLTI] NVARCHAR(MAX) NOT NULL,
	...
	INDICADORC NVARCHAR(MAX) NOT NULL,
	[CCNCRM] NVARCHAR(MAX) NOT NULL,
	[CNTTTL] NVARCHAR(MAX) NOT NULL,
	...
	INDICADORO NVARCHAR(MAX) NULL,
	[ODFCOD] NVARCHAR(MAX) NULL,
	[ODFVAL] NVARCHAR(MAX) NULL,


	INDICADORP NVARCHAR(MAX) NULL,
...
SELECT DISTINCT 
		...
		(CASE (C.TIC_CODIGO)							--Categoria
			...
			ELSE C.TIC_CODIGO							--03 EXPORTACI�N, 04 EMPRESA, 05 DISTRIBUIDORA*/
		END) 
	   AS [BCGCOD],										
	   C.CL_CODIGO AS [BPCNUM],							--Codigo de cliente automatico  (Lo dejamos vac�o)	
	   2 AS [BPRNAM],								    --Razon Social (Opcion 2 - 1) Si 2) No)
	   C.CL_NOMBRE AS [BPRSHO],							--Descrip. corta "OBLIGATORIO"  (Ac� va la Raz�n Social)
	   LEFT(C.[CL_CODIGO], 10) AS [BPRLOG],				--Sigla del cliente equivale al c�digo de cliente en Zeus
	   ...
	   'SPA' AS [LAN],									--Idioma (SPA-Espa�ol ENG-Ingl�s)  (A definir por la gente de ADONIX)
	   (CASE C.CL_CUIT 
			WHEN '' THEN 'A DEFINIR'
			ELSE C.CL_CUIT
	    END)
	   AS [CRN],										--N.I.F. (N�mero de CUIT)
														--(Consultar a la gente de ADONIX, te pide longuitud 3)
	   'ARS' AS [CUR],									--Divisa (ARS-Peso, USD-D�lar)
	   /**CAMPOS OBLIGATORIO - A DEFINIR **********/

	   'D' AS [ABCCLS],									--Categor�a ABC   1) Clase A, 2) Clase B, 3) Clase C,  4) Clase D (Para la importancia en volum�n de negocios)
									
	   '2' AS [DME],									--Entrega parcial 1) Autorizada, 2) L�nea completa, 3) Pedido completo (Modo de entrega para los pedidos)
	  
	   '2' AS [FREINV],									--Facturaci�n porte Determina si el transporte del pedido se le factura al cliente o no 
	   ...
	   C.CL_CODIGO AS [BPCINV],									--Cliente factura (Va a ser el mismo c�digo de cliente, la gente de adonix nos lo va a pasar)  -- Consultar
														--Lo mismo que el campo BPCNUM
	   '' AS [BPAINV],								    --Direcci�n  (C�digo de direcci�n de facturaci�n sugerido)
														/*Va a ser el mismo campo que BPAADD*/
														/* C.CL_CODIGO */ 
	   '' AS [BPCPYR],				--Cliente pagador (Aqui traemos el mismo c�digo del cliente BPCNUM)
	   '' AS [BPAPYR],								    --Direcci�n (Direcci�n del cliente pagador)mismo campo que BPAADD
	   '' AS [BPCRSK],									--Cliente riesgo (C�digo del cliente en curso)c�digo del cliente BPCNUM
	   '' AS [BPDADD],									--Direcci�n  (Direcci�n del cliente en curso)mismo campo que BPAADD
	    /************/

	   2 AS [BPAADD],									--Direc. por defecto 1) No - 2) Si
	   '' AS [ACCCOD],									--C�digo contable (Tiene que verlo la gente de contaduria)
	   CASE C.CL_IVA 
			WHEN 1 THEN 'CF'
			WHEN 2 THEN 'RI'
			WHEN 3 THEN 'RNI'
	   ...
	   (CASE C.CVE_CODIGO 
			...
			ELSE C.CVE_CODIGO
		END)
	   AS [PTE],										--Condici�n pago (Ver si se van a usar los mismos del Zeus)
	   (CASE C.CL_CUIT  
			WHEN '' THEN 'A DEFINIR'
			ELSE C.CL_CUIT
		END
	   ) AS [XX12NIF],									--N�mero de CUIT/CUIL
	   ...
	   C.CL_DOCUME AS [XX12DOCNUM],					   --N�mero de Documento  		 
	   '' AS [XX12REGIIBB],								--R�gimen IIBB  1) CM,  2) Local,  3) Todas
	   C.CL_IBR AS [XX12IIBB],							--N�m Ingresos Brutos
	   ...
	   '' AS [*82],										--Texto factura
	   'A' AS 'A',										--
	  C.CL_DIRECC  AS [BPAADD2],						    --Direcci�n "OBLIGATORIA"
	    'A DEFINIR' AS [BPADES],							--Descripci�n
	   UPPER(LEFT(C.[CL_DIRECC], 50)) AS [BPAADDLIG(0)],--L�nea direcci�n
	   '' AS [BPAADDLIG(1)],							--L�nea direcci�n 	
	   '' AS [BPAADDLIG(2)],							--L�nea direcci�n
	   	      

	   CASE LEFT(C.[CL_CODPOS], 10)
		WHEN '' THEN 'A DEFINIR'
		ELSE LEFT(C.[CL_CODPOS], 10)
	   END AS [POSCOD],									--C�digo Postal "OBLIGATORIA"
	   ...
	   C.CL_EMAIL AS [WEB(0)],							--Direcci�n Internet
	   C.CL_EMAIL2 AS [WEB(1)],							--Direcci�n Internet
	   C.CL_EMAIL3 AS [WEB(2)],							--Direcci�n Internet
	   '' AS [FAX],										--FAX
	   
	   'D' AS 'D',										--
	   /*En la otra query PRI*/ '' AS [BPAADD3],			--Direcci�n entrega "OBLIGATORIA" (A definir)
	   C.CL_NOMBRE AS [BPDNAM(0)],				--Raz�n Social (Consultar si se coloca el mismo nombre igual que arriba)
	   'ARG' AS [VACBPR3],							--Reg.impuesto
	   '' AS [REP(0)3],							 		--Representante
	   '' AS [REP(1)3],									--Representante
	   '' AS [STOFCY],									--Planta expedici�n
	   '' AS [DRN],									    --N� ruta, 1) Ruta 1 2) Ruta 2 3) Ruta 3 "OBLIGATORIA" (A definir)
	   ...
	   '' AS [DAYLTI],									--Plazo ent. en d�as (A definir)
	   '' AS [*713],									--Texto preparaci�n
	   '' AS [*723],									--Texto preparaci�n
	   ...
	   END) AS 'CNTFNC',								/*Funci�n: "OBLIGATORIA"
															1)Presidente Directo Gral. 2)Director Comercial 3) Director T�cnico 4)Responsable de compras 5)Comprador
       ...
       '' AS [*1],										--Direcci�n: De la tabla Clientes Sucursal no hay direcci�n
	   CC.CLC_EMAIL  AS [WEB],							--E-mail
	   CC.CLC_TELEFO AS [MOB],		                    --M�vil
	   'O' AS 'O',										--
...
IF OBJECT_ID('tempdb..##TMPTABLE_CLIENTESSIGLA') IS NOT NULL
    DROP TABLE ##TMPTABLE_CLIENTESSIGLA


CREATE TABLE ##TMPTABLE_CLIENTESSIGLA (	
...
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('20001','00102','OEMNACIONAL')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('20002','00104','OEMNACIONAL')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('20003','00107','OEMNACIONAL')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('30001','07024','OEMEXTERIOR')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('30002','07046','OEMEXTERIOR')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('30003','07051','OEMEXTERIOR')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('40001','07002','OEMDISTEXT')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('40002','07010','OEMDISTEXT')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('40003','07015','OEMDISTEXT')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('40004','07032','OEMDISTEXT')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('100001','00009','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('100002','00010','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('100003','00011','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('110001','01592','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('110002','01593','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('110003','01616','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('120001','01632','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('120002','01889','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('120003','01889','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('130001','00953','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('130002','20085','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('130003','24992','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('140001','20214','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('140002','41632','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('140003','45888','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('150001','20159','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('150002','25080','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('150003','30575','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('160001','01641','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('160002','20101','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('160003','20219','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('170001','20130','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('170002','20201','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('170003','20204','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('180001','41725','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('180002','60329','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('180003','60813','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('190001','00090','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('190002','00146','MRARGENTINA')
INSERT INTO ##TMPTABLE_CLIENTESSIGLA VALUES ('190003','00150','MRARGENTINA')
...
OPEN CLIENTESSIGLA
	FETCH CLIENTESSIGLA INTO @codigoCliente, @sigla, @familiaEstadististica
...
--SELECT * 
--FROM ##TMPTABLE_CLIENTES
--ORDER BY [BPCNUM] ASC


--SELECT * 
--FROM ##TMPTABLE_CLIENTESSIGLA clienteSigla
--ORDER BY clienteSigla.codigoCliente ASC
...
INSERT INTO ##TMPDATA
SELECT distinct 
	clienteTmp.Indicador, --1
	clienteTmp.BCGCOD, --2
	clientesSiglas.codigoCliente, --3
	clienteTmp.BPRNAM, --4
	clienteTmp.BPRSHO, --5
	clienteTmp.BPRLOG, --6
	clienteTmp.CRY,  --7
	...
	clienteTmp.CRN,  --9
	clienteTmp.CUR,  --10
	clienteTmp.ABCCLS, --11
	clienteTmp.DME, --12
	clienteTmp.FREINV,  --13
	clienteTmp.IME, --14
	clienteTmp.INVPER,  --15
	clienteTmp.COMCAT,  --16
	clienteTmp.[REP(0)], --17
	clienteTmp.[REP(1)],  --18
	clienteTmp.[BPCTYP],  --19
	clienteTmp.[OSTCTL], --20
	clienteTmp.[OSTAUZ],  --21
	clienteTmp.[TSCCOD(0)], --22
	clienteTmp.[TSCCOD(1)], --23
	clienteTmp.[TSCCOD(2)], --24
	clienteTmp.[BPCINV],  --25
	clienteTmp.[BPAINV],  --26
	clienteTmp.[BPCPYR],  --27
	clienteTmp.[BPAPYR],  --28
	clienteTmp.[BPCRSK],  --29
	clienteTmp.[BPDADD],  --30
	clienteTmp.[BPAADD],  --31
	clienteTmp.[ACCCOD],  --32
	clienteTmp.[VACBPR],  --33
	clienteTmp.[PTE],  --34
	clienteTmp.[XX12NIF],  --35
	clienteTmp.[XX12DOCTYP], --36
	clienteTmp.[XXX12DOCTYP],  --37
	clienteTmp.[XX12DOCNUM],  --38
	clienteTmp.[XX12REGIIBB], --39
	clienteTmp.[XX12IIBB],  --40
	clienteTmp.[XX12SITGAN],  --41
	clienteTmp.[XX12MTBBPR],  --42
	clienteTmp.[XX12PERFLG],  --43
	clienteTmp.[XX12BPRINT],  --44
	clienteTmp.[*71],  --45
	clienteTmp.[*72], --46
	clienteTmp.[*81],  --47
	clienteTmp.[*82] --48
...
INSERT INTO ##TMPDATA
SELECT DISTINCT 
	clienteTmp.INDICADOR2, --1
	clienteTmp.[BPAADD2],  --2
	clienteTmp.[BPADES],   --3
	clienteTmp.[BPAADDLIG(0)], --4 
	clienteTmp.[BPAADDLIG(1)], --5
	clienteTmp.[BPAADDLIG(2)],  --6
	clienteTmp.[POSCOD],  --7
	clienteTmp.[CTY],   --8
	clienteTmp.[CRY2],  --9
	clienteTmp.[BPAADDFLG],  --10 
	clienteTmp.[TEL(0)], --11
	clienteTmp.[TEL(1)],  --12
	clienteTmp.[TEL(2)],  --13
	clienteTmp.[FCYWEB],  --14
	clienteTmp.[WEB(0)],  --15
	clienteTmp.[WEB(1)],  --16
	clienteTmp.[WEB(2)],  --17
	clienteTmp.[FAX],  --18
...
INSERT INTO ##TMPDATA
SELECT DISTINCT 
	clienteTmp.INDICADOR_D, --1
	clienteTmp.[BPAADD3], --2
	clienteTmp.[BPDNAM(0)], --3
	clienteTmp.[VACBPR3], --4
	clienteTmp.[REP(0)3], --5
	clienteTmp.[REP(1)3], --6
	clienteTmp.[STOFCY], --7
	clienteTmp.[DRN], --8
	clienteTmp.[DLVPIO], --9
	clienteTmp.[MDL], --10
	clienteTmp.[BPTNUM], --11
	clienteTmp.[DAYLTI], --12
	clienteTmp.[*713], --13
	clienteTmp.[*723],  --14
	clienteTmp.[*813], --15
	clienteTmp.[*823],  --16
